...
describe('total likes', () => {
    ...
    test('when list is empty it returns zero', () => {
    ...
    test('when list has negative likes, equals the sum of likes', () => {
        const result = listHelper.totalLikes(negativeLikesBlog)
...
describe('favorite blog', () => {
    ...
    test('when list is empty it returns null title', () => {
    ...
    test('when list has many blogs, equals title correct', () => {
        const result = listHelper.favoriteBlog(manyBlogs)
        assert.deepStrictEqual(result.title, "Canonical string reduction")
    })


    test('when list has negative likes, equals title of highest positive title', () => {
        const result = listHelper.favoriteBlog(negativeLikesBlog)
...
describe('most blogs', () => {
  ...
  test('when list is empty it returns null author and 0 blogs', () => {
  ...
  test('when list has many blogs, equals correcly the author with most blogs', () => {
...
describe('most likes', () => {
  ...
  test('when list is empty it returns null author and 0 likes', () => {
  ...
  test('when list has many blogs, equals correcly the author with most likes', () => {
      const result = listHelper.mostLikes(manyBlogs)
      assert.deepStrictEqual(result, {author:"Edsger W. Dijkstra",likes:17}) 
  }) 

  test('when list has many blogs even with neg likes, equals correcly the author with most likes', () => {
      const result = listHelper.mostLikes(negativeLikesBlog)
